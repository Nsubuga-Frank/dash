...
function Overlay(props) {
  var className = props.className,
    ...
    _onEnter = _props$onEnter === void 0 ? _utils.noop : _props$onEnter,
    _props$onExiting = props.onExiting,
    _onExiting = _props$onExiting === void 0 ? _utils.noop : _props$onExiting,
    _props$onEntering = props.onEntering,
    _onEntering = _props$onEntering === void 0 ? _utils.noop : _props$onEntering,
    _props$onEntered = props.onEntered,
    _onEntered = _props$onEntered === void 0 ? _utils.noop : _props$onEntered,
    _props$onExit = props.onExit,
    onExit = _props$onExit === void 0 ? _utils.noop : _props$onExit,
